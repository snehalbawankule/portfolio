          ...
          <Grid item xs={6} sm={6} md={7} lg={7}>
            <Grid container>
              <Grid item xs={6} sm={6} md={12} lg={12}>
                <TextWrap4 style={{ color: "#F44336" }}>Address</TextWrap4>
              </Grid>
              <Grid item xs={6} sm={6} md={6} lg={6}>
                <TextWrap4 style={{ color: "#928A97" }}>
            ...
            <Grid item xs={6} sm={6} md={6} lg={6}>
              <TextWrap4 style={{ color: "#F44336" }}>Phone</TextWrap4>
              <TextWrap4 style={{ color: "#928A97" }}>
                7028872940, 7020796299
              </TextWrap4>
            </Grid>
            <Grid item xs={6} sm={6} md={6} lg={6}>
              <TextWrap4 style={{ color: "#F44336" }}>Email</TextWrap4>
              <TextWrap4 style={{ color: "#928A97" }}>
